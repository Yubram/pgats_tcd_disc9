...
const message = "A alegria de fazer isso e funcionar, mas tem tanta informação que falta #desespero"
...
describe('Suit TCD: PGATS - Automação de Testes Web - POM', () => {
    ...
    it('TC060 - Preencher Formulário de Contate-nos e Anexar Arquivo -> Test Case 6: Contact Us Form', () => {
      ...
      contact_us.preencherFormularioDeContato(full_name, e_mail, subject, message, file) 
    });
